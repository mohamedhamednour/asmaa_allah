<template>
  <div class="getData">
    ...
    <div class="relative w-full">
        ...
        <input @focusout="valePagnation = 12" @focus="valePagnation = namesAllah.length + 1"  v-model="searchQuery" type="text" id="simple-search" class="bg-gray-50 border border-gray-300 text-[18px] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="ابحث عن اسم الله " required>
    </div>
